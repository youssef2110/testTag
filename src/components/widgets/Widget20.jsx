...
class Widget20Component extends Component {
  state = {
    degreeSign: "°C",
        ...
        <Portlet.Body className="p-0">
          ...
          <Widget9>
            <Widget9.Display>
              ...
              <Widget9.Text>
                {highlightContent}
                <Widget9.Degree>{degreeSign}</Widget9.Degree>
              </Widget9.Text>
            </Widget9.Display>
            <Widget9.Grid>
              {grid.map((data, index) => {
                ...
                return (
                  <Widget9.GridItem key={index}>
                    ...
                    <Widget9.GridText>{content}</Widget9.GridText>
                  </Widget9.GridItem>
                )
              })}
            </Widget9.Grid>
              ...
              {list.map((data, index) => {
                ...
                return (
                  <Widget9.ListItem key={index}>
                    <Widget9.ListText>{info}</Widget9.ListText>
                    <Widget9.ListAddon>
