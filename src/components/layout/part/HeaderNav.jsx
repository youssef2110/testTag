import { Nav, Badge, Caret, Dropdown, GridNav } from "@blueupcode/components"
    ...
    <Nav pills {...props}>
      ...
      <Dropdown.Uncontrolled nav>
        ...
        <Dropdown.Menu animated>
          ...
          <Dropdown.Submenu>
            <Dropdown.Item
              icon={<FontAwesomeIcon icon={SolidIcon.faTasks} />}
              addon={<Caret />}
            >
              Task manager
            </Dropdown.Item>
          ...
          {/* END Dropdown Submenu */}
          <Dropdown.Item
            icon={<FontAwesomeIcon icon={SolidIcon.faDollarSign} />}
          >
            Invoice
          </Dropdown.Item>
            ...
            <Dropdown.Col>
              ...
              <GridNav action>
                <GridNav.Row>
                  <GridNav.Item
                    icon={
                      <FontAwesomeIcon icon={RegularIcon.faWindowRestore} />
                    }
                  >
                    Dashboard
                  </GridNav.Item>
                  <GridNav.Item
                    icon={<FontAwesomeIcon icon={RegularIcon.faClipboard} />}
                  >
                    TODO List
                  </GridNav.Item>
                  <GridNav.Item
                    icon={
                      <FontAwesomeIcon icon={RegularIcon.faQuestionCircle} />
                    }
                  >
                    Help Center
                  </GridNav.Item>
                ...
                <GridNav.Row>
                  <GridNav.Item
                    icon={<FontAwesomeIcon icon={RegularIcon.faImages} />}
                  >
                    Galery
                  </GridNav.Item>
                  <GridNav.Item
                    icon={<FontAwesomeIcon icon={RegularIcon.faChartBar} />}
                  >
                    Scrumboard
                  </GridNav.Item>
                  <GridNav.Item
                    icon={<FontAwesomeIcon icon={RegularIcon.faBookmark} />}
                  >
                    Docs
                  </GridNav.Item>
                </GridNav.Row>
