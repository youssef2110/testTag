...
class BadgePage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Badge | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
          ...
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Change your badges size by setting <code>size</code>{" "}
                    property with <code>lg|xl</code> values.
                  </p>
                  {/* BEGIN Badges */}
                  <DemoWrapper>
                    <Badge variant="primary">Primary</Badge>{" "}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Make your badge into a circle or square shape by setting{" "}
                    <code>shape</code> property with <code>circle|square</code>{" "}
                    values.
                  </p>
                  <Row>
                    <Col md="6">
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    If you add <code>href</code> property to the badge elements
                    quickly provide <em>actionable</em> badges with hover and
                    focus states. Badge element will transform as{" "}
                    <code>{"<a>"}</code> tag
                  </p>
                  {/* BEGIN Badges */}
                  <DemoWrapper>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add <code>pill</code> prooperty to make badge element more
                    rounded.
                  </p>
                  {/* BEGIN Badges */}
                  <DemoWrapper>
