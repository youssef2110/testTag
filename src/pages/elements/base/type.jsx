...
class TypoghrapyPage extends Component {
  componentDidMount() {
    // Set header title
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Typhography | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    your document. Wrap <code>Blockquote</code> around any HTML
                    as the quote.
                  </p>
                  {/* BEGIN Blockquote */}
                  <Blockquote>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Stylized abbreviations implementation of HTML’s{" "}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    <strong>display heading</strong>—a larger, slightly more
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(TypoghrapyPage)))
