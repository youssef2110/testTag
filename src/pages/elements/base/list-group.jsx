...
class ListGroupPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>List Group | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>List group</strong> is a flexible and powerful
                    component for displaying a series of content. List group has
                    some border versions, look examples below.
                  </p>
                  <Row>
                    <Col md="3">
                      {/* BEGIN Portlet */}
          ...
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add <code>active</code> property to a{" "}
                    <code>ListGroup.Item</code> to indicate the current active
                    selection.
                  </p>
                  <p>
                    Add <code>disabled</code> property to a{" "}
                    <code>ListGroup.Item</code> to make it <em>appear</em>{" "}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add <code>horizontal</code> property to change the layout of
                    list group items from vertical to horizontal across all
                    breakpoints. Alternatively, choose a responsive variant by
                    set <code>horizontal</code> property with{" "}
                    <code>.sm|md|lg|xl</code> to make a list group horizontal
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    disabled, and active states by adding <code>action</code>{" "}
                    property. We separate these pseudo-classes to ensure list
                    groups made of non-interactive elements (like{" "}
                    <code>{"<li>"}</code>s or <code>{"<div>"}</code>s) don’t
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Use <code>variant</code> property to style list items with a
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add <Link href="/elements/base/badge">badges</Link> to any
                    list group item to show unread counts, activity, and more
                    with the help of some <strong>utilities</strong>.
                  </p>
                  {/* BEGIN List Group */}
                  <ListGroup bordered>
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(ListGroupPage)))
