...
class AccordionPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Accordion | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Accordion</strong> is collapsible elements extended
                    from <Link href="/elements/base/card">card</Link>, inside
                    accordion you can put any elements. We have two versions of
                    the accordion, like examples below. The first one is the
                    default accordion appearance. To appear your accordion like
                    the second one, you just need to add <code>flush</code>{" "}
                    property to default accordion.
                  </p>
                  <Row>
          ...
          <Collapse isOpen={activeCard === 5}>
            <Card.Body>
              <p className="mb-0">
                ...
                electronic typesetting, remaining essentially unchanged. It was
                popularised in the 1960s with the release of Letraset sheets
                containLorem Ipsum passages, and more recently with desktop
                publishing software like Aldus PageMaker including versions of
                Lorem Ipsum.
              </p>
            </Card.Body>
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(AccordionPage)))
