import { Row, Col, Portlet, Progress, Container } from "@blueupcode/components"
...
class ProgressPage extends Component {
  render() {
    return (
      <Fragment>
        <Head>
          <title>Progress | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Progress</strong> components are built with two HTML
                    elements, some CSS to set the width, and a few attributes.
                  </p>
                  {/* BEGIN Progresses */}
                  ...
                  <Portlet>
                    <Portlet.Body>
                      <p>
                        ...
                        <code>Progress</code> component to apply a stripe via
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Use <code>variant</code> property to change the appearance
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Use <code>size</code> property to change progress element
                    height.
                  </p>
                  {/* BEGIN Progresses */}
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(ProgressPage)))
