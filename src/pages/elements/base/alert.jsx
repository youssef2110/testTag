import { Row, Col, Alert, Portlet, Container } from "@blueupcode/components"
...
class AlertPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Alert | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Alerts</strong> are available for any length of
                    text, as well as an optional dismiss button. For proper
                    styling, use one of the eight <strong>required</strong>{" "}
                    contextual classes
                  </p>
                  <Row>
                    <Col md="4">
                      ...
                      <Portlet>
                        ...
                        <Portlet.Body>
                          <p>
                            Use <code>variant</code> property to apply
                            contextual colors
                          </p>
                          {/* BEGIN Alerts */}
                    ...
                    <Col md="4">
                      ...
                      <Portlet>
                        ...
                        <Portlet.Body>
                          <p>
                            Fill <code>variant</code> property with{" "}
                          ...
                          <Alert variant="outline-light" className="mb-0">
                            Light
                          </Alert>
                          {/* END Alerts */}
                        </Portlet.Body>
                    ...
                    <Col md="4">
                      ...
                      <Portlet>
                        ...
                        <Portlet.Body>
                          ...
                          <Alert variant="label-light" className="mb-0">
                            Light
                          </Alert>
                          {/* END Alerts */}
                        </Portlet.Body>
          ...
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Use the <code>Alert.Link</code> component to quickly provide
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    If you want to put icon into alert element, you can use{" "}
                    <code>icon</code> property and fill it with your icon.
                  </p>
                  {/* BEGIN Alerts */}
                  <Alert
                    variant="primary"
                    icon={<FontAwesomeIcon icon={SolidIcon.faArchive} />}
                  >
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    It’s possible to dismiss any alert inline. For the most
                    basic use-case an uncontrolled component can provide the
                    functionality wanted without the need to manage/control the
                    state of the component. <code>Alert.Uncontrolled</code> does
                    not require <code>isOpen</code> nor <code>toggle</code>{" "}
                    props to work.
                  </p>
                  {/* BEGIN Alerts */}
                  <AlertControlled />
...
class AlertControlled extends Component {
  // Default state
  state = { isOpen: true }
