import { Row, Col, GridNav, Portlet, Container } from "@blueupcode/components"
...
class GridNavPage extends Component {
  componentDidMount() {
    // Set header title
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Grid Navigation | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Grid navigation</strong> has 3 versions of the
                    border, like example below
                  </p>
                  <Row>
                    <Col md="4">
                      {/* BEGIN Portlet */}
          ...
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    You can add multiple rows and more content by using{" "}
                    <code>GridNav.Title</code> and <code>GridNav.Subtitle</code>
                  </p>
                  {/* BEGIN Grid Nav */}
                  <GridNav bordered>
                    <GridNav.Row>
                      <GridNav.Item
                        icon={
                          <FontAwesomeIcon icon={RegularIcon.faAddressCard} />
                        }
                      >
                    ...
                    <GridNav.Row>
                      <GridNav.Item
                        icon={
                          <FontAwesomeIcon icon={RegularIcon.faCalendarCheck} />
                        }
                      >
                      ...
                      <GridNav.Item
                        icon={
                          <FontAwesomeIcon icon={RegularIcon.faStickyNote} />
                        }
                      >
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Apply hover and focus states by adding <code>action</code>{" "}
                    property. Use <code>active</code> property to appear clicked
                    effect to individual link and use <code>disabled</code>{" "}
                    property for disabled appearance.
                  </p>
                  {/* BEGIN Grid Nav */}
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(GridNavPage)))
