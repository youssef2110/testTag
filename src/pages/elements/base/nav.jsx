...
class NavPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Navigation | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    The base <code>Nav</code> component is built with flexbox
                    and provide a strong foundation for building all types of
                    navigation components. It includes some style overrides (for
                    working with lists), some link padding for larger hit areas,
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        ...
                        <code>tabs</code> property to generate a tabbed
                        interface.
                      </p>
                      {/* BEGIN Nav */}
                      <Nav tabs>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    <Link href="/elements/base/badge">badge</Link>, icon or
                    caret to separate nav items, we provide{" "}
                    <code>Nav.Addon</code> for wrapping those elements.
                  </p>
                  {/* BEGIN Nav */}
                  <Nav pills vertical>
                    <Nav.Item href="#">
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add <code>size</code> property and fill it with{" "}
                    <code>lg|sm</code> to make navigations are larger or smaller
                  </p>
                  {/* BEGIN Nav */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add <code>vertical</code> property to <code>Nav</code>{" "}
                    elements for applying vertical appearance, but this feature
                    is not supported for tabs interface.
                  </p>
                  <Row>
                    <Col sm="6">
                      {/* BEGIN Portlet */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    <code>horizontal</code> property with{" "}
                    <code>start|center|end</code>. By default, navs are
                    left-aligned, but you can easily change them to center or
                    right aligned.
                  </p>
                  {/* BEGIN Nav */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Force your <code>Nav</code>&apos;s contents to extend the
                    full available width. To proportionately fill all available
                    space with your <code>Nav.Item</code>s, use{" "}
                    <code>fill</code> property. For equal-width elements, use{" "}
                    <code>justified</code> property. All horizontal space will
                    be occupied by nav links.
                  </p>
                  {/* BEGIN Nav */}
