...
class CardPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Card | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  ...
                  <p>
                    Card titles are used by using <code>Card.Title</code>{" "}
                    component. In the same way, links are added and placed next
                    to each other by using <code>Card.Link</code> component.
                  </p>
                  <p>
                    Subtitles are used by using a <code>Card.Subtitle</code>{" "}
                    component. If the <code>Card.Title</code> and the{" "}
                    <code>Card.Subtitle</code> components are placed in a{" "}
                    <code>Card.Body</code> component, the card title and
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    styles, blocks, text styles, and a list group—all wrapped in
                    a fixed-width card.
                  </p>
                  <Row>
                    <Col sm="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Using a combination of grid and utility classes, cards can
                    be made horizontal in a mobile-friendly and responsive way.
                    In the example below, we remove the grid gutters with{" "}
                    <code>noGutters</code> property and use <code>Col</code>{" "}
                    component to make the card horizontal at the <code>md</code>{" "}
                    breakpoint. Further adjustments may be needed depending on
                    your card content.
                  </p>
                  {/* BEGIN Card */}
                  <Card>
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <code>Card.Img</code> with <code>top</code> property places
                    an image to the top of the card. With <code>Card.Text</code>
                    , text can be added to the card. Text within{" "}
                    <code>Card.Text</code> can also be styled with the standard
                    HTML tags.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    text. Depending on the image, you may or may not need
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add an optional header and/or footer within a card. Card
                    header can be contain title, icon, or other elements.
                  </p>
                  {/* BEGIN Card */}
                  <Card className="mb-3">
                    <Card.Header>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    entirety or specific parts—with our{" "}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    element with equal width and height columns.
                  </p>
                  <CardGroup>
                    {/* BEGIN Card */}
                    <Card>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    attached to one another? Use card decks.
                  </p>
                  <CardDeck>
                    {/* BEGIN Card */}
                    <Card>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    CSS by wrapping them in <code>CardColumns</code> component.
                    Cards are built with CSS <code>column</code> properties
                    instead of flexbox for easier alignment. Cards are ordered
