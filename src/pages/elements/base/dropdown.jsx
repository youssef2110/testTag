...
class DropdownPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Dropdown | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
                ...
                <Portlet.Body>
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      <p className="mt-2 mb-0">
                        Extend <code>Dropdown.Menu</code> with{" "}
                        <code>animated</code> to apply animation when dropdown
                        opened
                      </p>
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      {/* END Dropdown */}
                      <p className="mt-2 mb-0">
                        Use <code>icon</code> property with an icon inside to
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      {/* END Dropdown */}
                      <p className="mt-2 mb-0">
                        You can add circle bullet by using <code>bullet</code>{" "}
                        property in <code>Dropdown.Item</code>
                      </p>
                    </Col>
                  </Form.Group>
                  {/* END Form Group */}
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      <p className="mt-2 mb-0">
                        ...
                        <code>Dropdown.Header</code>. If you want to make
                        dropdown header larger, you must extend the component
                        with <code>size</code> property
                      </p>
                    </Col>
                  </Form.Group>
                  {/* END Form Group */}
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      {/* END Dropdown */}
                      <p className="mt-2 mb-0">
                        Dividing your dropdown items with{" "}
                        <code>Dropdown.Divider</code> component
                      </p>
                    </Col>
                  </Form.Group>
                  {/* END Form Group */}
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      <p className="mt-2 mb-0">
                        ...
                        <code>direction</code> with{" "}
                        <code>left|right|down|up</code> to <code>Dropdown</code>{" "}
                        components
                      </p>
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      {/* END Dropdown */}
                      <p className="mt-2 mb-0">
                        Apply <code>right</code> property to the{" "}
                        <code>Dropdown.Menu</code> to change alignment
                      </p>
                    </Col>
                  </Form.Group>
                  {/* END Form Group */}
                  ...
                  <Form.Group row className="mb-0">
                    ...
                    <Col sm="8" lg="9">
                      ...
                      <p className="mb-0 mt-2">
                        Combine <code>Dropdown.Row</code> and{" "}
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(DropdownPage)))
