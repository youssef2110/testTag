...
class SpinnerPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Spinner | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Spinners</strong> can be used to show the loading
                    state in your projects. You can customize the color with
          ...
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Using <code>size</code> property to make a smaller spinner
                    or, use custom CSS or inline styles to change the dimensions
                    as needed.
                  </p>
                  {/* BEGIN Spinners */}
                  <Spinner size="sm" />
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(SpinnerPage)))
