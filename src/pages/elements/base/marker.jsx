...
class MarkerPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Marker | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Marker</strong> is component that you can use for
                    marking something with shape and color, you can combine it
                    with many components. Marker by default has 3 different
                    shapes, like the example below. Change marker color by
                    applying <code>variant</code> property
                  </p>
                  <Row>
                    <Col md="4">
                      {/* BEGIN Portlet */}
                      <Portlet className="mb-md-0">
                        ...
                        <Portlet.Body>
                          <p>
                            Apply <code>type=&quot;dot&quot;</code> property for
                            this shape
                          </p>
                          {/* BEGIN Markers */}
                          <DemoWrapper>
                    ...
                    <Col md="4">
                      ...
                      <Portlet className="mb-md-0">
                        ...
                        <Portlet.Body>
                          <p>
                            Apply <code>type=&quot;circle&quot;</code> property
                            for this shape
                          </p>
                          {/* BEGIN Markers */}
                          <DemoWrapper>
                    ...
                    <Col md="4">
                      ...
                      <Portlet className="mb-0">
                        ...
                        <Portlet.Body>
                          <p>
                            Apply <code>type=&quot;pill&quot;</code> property
                            for this shape
                          </p>
                          {/* BEGIN Markers */}
                          <DemoWrapper>
          ...
          <Row>
            <Col md="6">
              ...
              <Portlet className="mb-md-0">
                ...
                <Portlet.Body>
                  <p>
                    Change marker size to smaller or larger by setting{" "}
                    <code>size</code> property with <code>sm|lg</code>
                  </p>
                  {/* BEGIN Markers */}
                  <DemoWrapper>
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(MarkerPage)))
