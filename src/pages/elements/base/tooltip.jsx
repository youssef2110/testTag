...
class TooltipPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Tooltip | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      <TooltipControlled />
                      <Button id="tooltip2" className="ml-2">
                        Uncontrolled
                      </Button>
                      <Tooltip.Uncontrolled target="tooltip2">
                        Tooltip content
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      <p className="mb-0 mt-2">
                        Set <code>placement</code> property with{" "}
                        <code>top|bottom|right|left</code> to change tooltip
                        placement
                      </p>
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      <p className="mb-0 mt-2">
                        You can put HTML content inside tooltip elements
                      </p>
                    </Col>
                  </Form.Group>
                  {/* END Form Group */}
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(TooltipPage)))
