...
class ModalPage extends Component {
  render() {
    return (
      <Fragment>
        <Head>
          <title>Modal | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
                ...
                <Portlet.Body>
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      ...
                      <p className="mb-0 mt-2">
                        Add <code>bordered</code> property to modal header or
                        footer elements for bordered styles
                      </p>
                    </Col>
                  </Form.Group>
                  {/* END Form Group */}
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      <Modal4 />
                      <p className="mb-0 mt-2">
                        Disable backdrop behavior (don&apos;t close modal when
                        backdrop clicked)
                      </p>
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      <Modal6 />
                      <p className="mb-0 mt-2">
                        Apply <code>scrollable</code> property to make modal
                        body fixed and scrollable
                      </p>
                    </Col>
                  </Form.Group>
                  {/* END Form Group */}
                  ...
                  <Form.Group row>
                    ...
                    <Col sm="8" lg="9">
                      <Modal7 />
                      <p className="mb-0 mt-2">
                        Make your modal align center to page by applying{" "}
                        <code>centered</code> property
                      </p>
                    </Col>
                  </Form.Group>
                  {/* END Form Group */}
        ...
        <Modal isOpen={this.state.isOpen} toggle={this.toggle}>
          ...
          <Modal.Body>
            <p className="mb-0">
              ...
              Cupiditate fugit eveniet sed, ipsum rem quasi quisquam recusandae
              nesciunt deleniti iste sit repellat rerum amet. Neque debitis
              iste, quos repudiandae ut!
            </p>
          </Modal.Body>
          <Modal.Footer>
