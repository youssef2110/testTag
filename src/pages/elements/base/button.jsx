...
class ButtonPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Button | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col xs="12">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        These is a standard button variant, you can use it by
                        setting <code>variant</code> property with contextual
                        color
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        Replace the default <code>variant</code> property value
                        with <code>outline-(color)</code> to apply these
                        variants
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        Replace the default <code>variant</code> property value
                        with <code>flat-(color)</code> to apply these variants
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        Replace the default <code>variant</code> property value
                        with <code>label-(color)</code> to apply these variants
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
                  ...
                  <Portlet className="mb-0">
                    ...
                    <Portlet.Body>
                      <p>
                        Replace the default <code>variant</code> property value
                        with <code>text-(color)</code> to apply these variants
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
          ...
          <Row>
            <Col md="7">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Extend button element with <code>pill</code> property to
                  ...
                  <DemoWrapper>
                    ...
                    <Button pill variant="label-secondary">
                      Secondary
                    </Button>{" "}
                    <Button pill variant="outline-success">
                      Success
                    </Button>{" "}
                    <Button pill variant="outline-warning">
                      Warning
                    </Button>{" "}
                    <Button pill variant="flat-danger">
                      Danger
                    </Button>{" "}
                    <Button pill variant="flat-info">
                      Info
                    </Button>{" "}
                    <Button pill variant="dark">
                      Dark
                    </Button>{" "}
                    <Button pill variant="light">
                      Light
                    </Button>
                  </DemoWrapper>
                  {/* END Buttons */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Make your button larger or smaller by setting{" "}
                    <code>size</code> property with <code>sm|lg</code> to
                    button.
                  </p>
                  {/* BEGIN Buttons */}
                  <DemoWrapper>
                    ...
                    <Button pill variant="dark" size="sm">
                      Smaller
                    </Button>{" "}
                    <Button pill variant="success">
                      Default
                    </Button>{" "}
                    <Button pill variant="info" size="lg">
                      Larger
                    </Button>
                  </DemoWrapper>
                  {/* END Buttons */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    You can&apos;t use the properties below together with{" "}
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        Fill <code>width</code> property with{" "}
                        <code>wide|wider|widest</code> to make your button wider
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        Fill <code>height</code> property with{" "}
                        <code>tall|taller|tallest</code> to make your button
                        taller
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
                  ...
                  <Portlet className="mb-0">
                    ...
                    <Portlet.Body>
                      <p>
                        Add <code>block</code> property for full width button
                        style.
                      </p>
                      {/* BEGIN Buttons */}
                      ...
                      <Button block variant="label-primary">
                        Block
                      </Button>
                      {/* END Buttons */}
                    </Portlet.Body>
            ...
            <Col md="5">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        If you need square button with an icon inside, you can
                        use <code>icon</code> property.
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        Make your icon buttons circular by extending button
                        element with <code>circle</code> property.
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        If you want to use icon with text, you don&apos;t need
                        to apply <code>icon</code> property
                      </p>
                      {/* BEGIN Buttons */}
                      <DemoWrapper>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add <code>active</code> or <code>disabled</code> properties
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    You can add a counter or marker to button by adding{" "}
                    <code>Button.Marker</code> and <code>Button.Counter</code>{" "}
                  ...
                  <DemoWrapper>
                    ...
                    <Button variant="primary">
                      Button
                      <Button.Marker>
                        <Button.Counter pill variant="secondary">
                          12
                        </Button.Counter>
                      </Button.Marker>
                    </Button>{" "}
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(ButtonPage)))
