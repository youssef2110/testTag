...
class ButtonGroupPage extends Component {
  render() {
    return (
      <Fragment>
        <Head>
          <title>Button Group | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Wrap a series of <code>Button</code> elements in{" "}
                    <code>ButtonGroup</code> element.
                  </p>
                  {/* BEGIN Button Group */}
                  <ButtonGroup>
                    <Button>Left</Button>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Instead of applying button sizing properties to every button
                    in a group, just set <code>variant</code> with{" "}
                    <code>sm|lg</code> to each <code>ButtonGroup</code>,
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Create split button dropdowns with virtually the same markup
                    as single button dropdowns, but with the addition of{" "}
                    <code>split</code> property for proper spacing around the
                    dropdown caret.
                  </p>
                  {/* BEGIN Button Group */}
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add <code>group</code> property to the dropdown element when
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    of butons for more components like toolbars.
                  </p>
                  {/* BEGIN Portlet */}
                  <Portlet>
                    <Portlet.Header bordered>
...
class ButtonGroupCheckbox extends Component {
  // Default states
  state = {
    1: true,
    2: false,
...
export default withAuth(withLayout(ButtonGroupPage))
