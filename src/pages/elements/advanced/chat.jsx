...
class ChatPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Chat | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Chat</strong> elements as the name suggests can be
                    used for messaging. To make chat bubbles use{" "}
                    <code>Chat.Bubble</code> component. Wrap your chat bubbles
                    into <code>Chat.Content</code>. You must set chat items
                    alignment by extend <code>Chat.Item</code> component with{" "}
                    <code>align</code> property.
                  </p>
                  {/* BEGIN Chat */}
                  <Chat>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    You can put your{" "}
                    <Link href="/elements/advanced/avatar">avatar</Link> into
                    the chat elements. Use <code>Chat.Avatar</code> component
                    instead the default avatar component.
                  </p>
                  {/* BEGIN Chat */}
                  <Chat>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Chat section is an element that can be used for marking time
                    section, look the example.
                  </p>
                  {/* BEGIN Chat */}
                  <Chat>
                    <Chat.Item content align="right">
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Change the bubble color with <code>variant</code> property
                    to differentiate each chat bubbles.
                  </p>
                  {/* BEGIN Chat */}
                  <Chat>
                    <Chat.Item content align="right">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    You can put chat bubble into another bubble to make
                    mentioned message. Insert images or any elements to make
                    more rich messages.
                  </p>
                  {/* BEGIN Chat */}
                  <Chat>
