...
class TimelinePage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Timeline | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Timeline</strong> can be used for listing agenda.
                    Use <Link href="/elements/base/marker">marker</Link> as the
                    timeline pin. Put your content into{" "}
                    <code>Timeline.Item</code>.
                  </p>
                  {/* BEGIN Timeline */}
                  <Timeline>
                    <Timeline.Item
                      pin={<Marker type="dot" variant="primary" />}
                    >
                      <p className="mb-0">Lorem ipsum dolor sit amit</p>
                    </Timeline.Item>
                    <Timeline.Item
                      pin={<Marker type="dot" variant="success" />}
                    >
                      <p className="mb-0">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Use your creativity to make a more complex timeline. In the
                    example below, we use{" "}
                    <Link href="/elements/advanced/rich-list">rich list</Link>{" "}
                    to appear bordered and clickable timeline item.
                  </p>
                  {/* BEGIN Timeline */}
                  <Timeline className="rich-list-bordered rich-list-action">
                    <Timeline.Item
                      pin={<Marker type="circle" variant="primary" />}
                    >
                      {/* BEGIN Rich List */}
                      <RichList.Item>
                    ...
                    <Timeline.Item
                      pin={<Marker type="circle" variant="success" />}
                    >
                      {/* BEGIN Rich List */}
                      <RichList.Item>
                        <RichList.Addon addonType="prepend">
                    ...
                    <Timeline.Item
                      pin={<Marker type="circle" variant="danger" />}
                    >
                      {/* BEGIN Rich List */}
                      <RichList.Item>
                        <RichList.Addon addonType="prepend">
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add time information to your timeline by setting{" "}
                    <code>time</code> property and you must add{" "}
                    <code>timed</code> property to <code>Timeline</code>{" "}
                    component.
                  </p>
                  {/* BEGIN Timeline */}
                  <Timeline timed>
                    ...
                    <Timeline.Item
                      time="14.05"
                      pin={<Marker type="dot" variant="danger" />}
                    >
                      <p className="mb-0">
                        Lorem ipsum dolor sit amit,consectetur eiusmdd tempor
                        incididunt ut labore et dolore magna elit enim at minim
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    We have one more timeline version, you just need to add{" "}
                    <code>zigzag</code> property to default timeline elements to
                    appear like below.
                  </p>
                  {/* BEGIN Timeline */}
                  <Timeline zigzag>
                    ...
                    <Timeline.Item
                      pin={<Marker type="circle" variant="info" />}
                    >
                      <p className="mb-0">
                        Lorem ipsum dolor sit amit,consectetur eiusmdd tempor
                        incididunt ut labore et dolore magna
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(TimelinePage)))
