...
class RichListPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Rich List | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    <strong>Rich list</strong> is a flexible and powerful
                    component for displaying a series of content. Basic rich
                    list has <code>RichList.Item</code> where wrapping content
                    or any elements.
                  </p>
                  {/* BEGIN Rich List */}
                  <RichList>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    By default, rich list component has 2 border versions, like
                    the examples below.
                  </p>
                  {/* BEGIN Portlet */}
                  <Portlet>
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Put other elements inside rich list within{" "}
                    <code>RichList.Addon</code>
                  </p>
                  {/* BEGIN Rich List */}
                  <RichList>
                    <RichList.Item>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    If you want to make your rich list has clickable behavior,
                    you must add <code>action</code> property.
                  </p>
                  {/* BEGIN Rich List */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    We provide <code>active</code> and <code>disabled</code>{" "}
                    states for <code>RichList.Item</code>, look the example
                  </p>
                  {/* BEGIN Rich List */}
                  <RichList bordered action>
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(RichListPage)))
