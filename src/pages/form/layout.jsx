...
class FormLayoutPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Form Layout | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
            ...
            <Col md="6">
              ...
              <Portlet>
                <Portlet.Header bordered>
                  <Portlet.Title>
                    Basic layout with floating label
                  </Portlet.Title>
                </Portlet.Header>
                <Portlet.Body>
                  {/* BEGIN Form */}
              ...
              <Portlet>
                <Portlet.Header bordered>
                  <Portlet.Title>
                    Complex layout with floating label
                  </Portlet.Title>
                </Portlet.Header>
                <Portlet.Body>
                  {/* BEGIN Form */}
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(FormLayoutPage)))
