...
class FormCustomPage extends Component {
  componentDidMount() {
    // Set header title
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Custom Form | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Use <code>{'<CustomInput type="select">'}</code> to trigger
                    the custom styles. Cannot modify the{" "}
                    <code>{"<option>"}</code>s due to browser limitations.
                  </p>
                  <p>
                    You may also choose from small and large custom selects to
                    match our similarly sized text inputs.
                  </p>
                  <hr />
                  {/* BEGIN Form Group */}
                  <Form.Group>
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Put <code>Input</code> and <code>Label</code> components
                    into <code>FloatLabel</code> component. The label element
                    will float above the placeholder and when the cursor focuses
                    on input, the label will be floating to the top of input
                    element.
                  </p>
                  <hr />
                  {/* BEGIN Form Group */}
                  ...
                  <hr />
                  <p>
                    To change input element size, you can set <code>size</code>{" "}
                    property.
                  </p>
                  <hr />
                  {/* BEGIN Form Group */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    <code>disabled</code> boolean property to the component and
                    the custom indicator and label description will be
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    <code>{'type="switch"'}</code> to render a toggle switch.
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(FormCustomPage)))
