...
class FormBasePage extends Component {
  componentDidMount() {
    // Set header title
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Base Form | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Use <code>Input</code> component to make the most forms.
                    Included are styles for general appearance, focus state,
                    sizing, and more.
                  </p>
                  <hr />
                  {/* BEGIN Form Group */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add the <code>readOnly</code> boolean property on an input
                    to prevent modification of the input’s value. Read-only
                    inputs appear darker (just like disabled inputs), but retain
                    the standard cursor.
                  </p>
                  <hr />
                  {/* BEGIN Form Group */}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    ...
                    elements in your form styled as plain text, add the{" "}
                    <code>plainText</code> property to remove the default form
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Add the <code>disabled</code> boolean property on an input
                    to prevent user interactions and make it appear darker.
                  </p>
                  <hr />
                  {/* BEGIN Form Group */}
                  <Form.Group className="mb-0">
            ...
            <Col md="6">
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  <p>
                    Set heights using <code>size</code> property with{" "}
              ...
              <Portlet>
                ...
                <Portlet.Body>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        ...
                        immediate sibling will be vertically stacked and
                        appropriately spaced with{" "}
                        <code>{"<Form.Group check>"}</code>.
                      </p>
                      <hr />
                      {/* BEGIN Form Group */}
                      <Form.Group check>
                  ...
                  <Portlet>
                    ...
                    <Portlet.Body>
                      <p>
                        Add <code>.position-static</code> to inputs within{" "}
                        <code>{"<Form.Group check>"}</code> that don’t have any
                        label text. Remember to still provide some form of label
                  ...
                  <Portlet className="mb-0">
                    ...
                    <Portlet.Body>
                      <p>
                        ...
                        adding <code>inline</code> property to any{" "}
                        <code>{"<Form.Group check>"}</code>.
                      </p>
                      <hr />
                      {/* BEGIN Form Group */}
                      <Form.Group check inline>
                        <Input
                          ...
                          id="checkboxInline1"
                        />
                        <Label check for="checkboxInline1">
                          1
                        </Label>
                      </Form.Group>
                      {/* END Form Group */}
                      ...
                      <Form.Group check inline>
                        <Input
                          ...
                          id="checkboxInline2"
                        />
                        <Label check for="checkboxInline2">
                          2
                        </Label>
                      </Form.Group>
                      {/* END Form Group */}
                      ...
                      <Form.Group check inline className="mb-0">
                        <Input
                          ...
                          disabled
                        />
                        <Label check for="checkboxInline3">
                          3 (disabled)
                        </Label>
                      </Form.Group>
                      {/* END Form Group */}
