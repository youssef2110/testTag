...
class PortletTabPage extends Component {
  componentDidMount() {
    // Set header title
  ...
  render() {
    return (
      <Fragment>
        <Head>
          <title>Portlet Tab | {PAGE.siteName}</title>
        </Head>
        <Container fluid>
          <Row>
            <Col md="4">
...
class PortletTab1 extends Component {
...
class PortletTab2 extends Component {
  // Default active tab id
  state = { activeTab: 1 }
...
class PortletTab3 extends Component {
  // Default active tab id
  state = { activeTab: 1 }
...
class PortletTab4 extends Component {
  // Default active tab id
  state = { activeTab: 1 }
...
class PortletTab5 extends Component {
  // Default active tab id
  state = { activeTab: 1 }
...
class PortletTab6 extends Component {
  // Default active tab id
  state = { activeTab: 1 }
...
class PortletTab7 extends Component {
  // Default active tab id
  state = { activeTab: 1 }
...
export default connect(
  null,
  mapDispathToProps
)(withAuth(withLayout(PortletTabPage)))
